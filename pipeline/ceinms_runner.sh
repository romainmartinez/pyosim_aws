...
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 1_markers.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 2_emg.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 3_forces.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 4_scaling.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 5_inverse_kinematics.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 6_inverse_dynamics.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 7_static_optimization.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 8_muscle_analysis.py" >> $log_file
ssh -X -i $pem_file $distant_user_name@$hostname "cd $running_python_script_path; $python_executable 9_joint_reaction.py" >> $log_file
echo "Done"
echo ""

# Copy back the project_sample
mkdir final_results
...
ssh -i $pem_file $distant_user_name@$hostname "rm -rf $distant_user_name@$hostname:${$running_python_script_path}project_sample"
echo "Done"
echo ""
